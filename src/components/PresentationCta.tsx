      ...
      <div className="relative overflow-hidden rounded-[7px] bg-white/[0.96] px-5 py-6 shadow-glass backdrop-blur md:px-8 md:py-7">
        ...
        <div className="grid gap-6 lg:grid-cols-[0.82fr_1.18fr] lg:items-center">
          ...
          <div className="grid gap-3 md:grid-cols-3">
            <a href={telegramHref} target="_blank" rel="noreferrer" className="inline-flex min-h-12 items-center justify-center gap-3 rounded-md bg-cobalt px-4 py-3 text-sm font-semibold text-white shadow-glass transition hover:-translate-y-0.5 hover:bg-ink">
              Связаться <MessageCircle size={18} />
            </a>
            <a href={deckHref} download className="inline-flex min-h-12 items-center justify-center gap-3 rounded-md border border-cobalt/20 bg-white px-4 py-3 text-sm font-semibold text-cobalt transition hover:-translate-y-0.5 hover:border-cobalt/35 hover:bg-cobalt/5">
              Скачать презентацию <Download size={18} />
            </a>
            <Link href="/stages" className="inline-flex min-h-12 items-center justify-center gap-3 rounded-md border border-cobalt/20 bg-white px-4 py-3 text-sm font-semibold text-cobalt transition hover:-translate-y-0.5 hover:border-cobalt/35 hover:bg-cobalt/5">

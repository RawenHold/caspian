...
const stage0Roles: RoleTask[] = [
  {
    ...
    tasks: [
      ...
      "Зафиксировать, что не входит в MVP: полный ticketing, онлайн-оплаты, mobile apps, B2B кабинет.",
    ],
  },
  {
...
const stage2Roles: RoleTask[] = [
  ...
  },
  {
    ...
    tasks: [
      ...
      "Подготовить AZ/RU/EN тексты, title, description, OG и внутренние ссылки.",
    ],
  },
  {
...
const stage4Roles: RoleTask[] = [
  ...
  {
    role: "Фронтенд",
    focus: "Показать локальную дифференциацию Caspian UBook.",
    tasks: [
...
export const phases: Phase[] = [
  ...
  },
  {
    ...
    summary: "Backend, БД, вход через Google/Apple/email/phone, аккаунт, admin shell, CI/CD и staging.",
  ...
  },
  {
    ...
    dod: ["Все informational страницы опубликованы", "CTA ведут на AI/support или правильную форму", "SEO-поля заполнены", "Ссылки проверены", "AZ/RU/EN страницы отображаются"],
  ...
  },
  {
    ...
    risk: "International acquiring для Азербайджана и split payments требуют отдельного подтверждения.",
  },
  {
    id: 11,
  ...
  },
  {
    ...
    deliverables: ["Loyalty / Caspian+", "API marketplace", "White-label", "Regional expansion", "Advanced AI"],
